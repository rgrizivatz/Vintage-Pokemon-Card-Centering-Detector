...
### ⚠ Difficult cases:
- Electric Pokémon or Pokémon cards with strong yellow backgrounds  
...
## 📊 Output Example (Ditto, Fossil, Japanese, 1997)

Below is a complete multi-panel result generated by the algorithm:

![Example Output](output.png)

This figure is produced automatically and contains the following six panels:

### **1. Original Card**
The raw, unmodified input image.

### **2. Original + Red Outer Frame**
The detected yellow border shown as a semi-transparent red overlay.

### **3. Quartiles Overlay**
Shows Q1, Q2 (median), and Q3 thickness values for each side (Left, Right, Top, Bottom).

### **4. Thickness Histograms (Cleaned)**
Histograms of border thickness after removing outliers with the IQR method.

### **5. Border Segments Used in Computation**
Shows valid border segments, colored by side:
- Left → blue  
- Right → orange  
- Top → green  
- Bottom → red  

### **6. Outer Yellow Border Mask**
Binary mask of the detected border (white = detected pixels).
